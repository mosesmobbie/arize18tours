    ...
    <div class="footer-inner">
        <div class="footer-brand">
            ...
            <ul class="footer-icons" style="display: flex; gap: 16px; align-items: center; padding: 12px; border-radius: 4px; margin-top: 16px; list-style: none;">
                ...
                <li style="display: inline;"><a title="WhatsApp" href="https://wa.me/{{ preg_replace('/\D/', '', $contact->whatsapp) }}" target="_blank" rel="noopener noreferrer"><span class="cta-icon   style="width:24px;height:24px;flex:0 0 24px;"></span><span class="sr-only">WhatsApp</span></a></li>
                @endif
