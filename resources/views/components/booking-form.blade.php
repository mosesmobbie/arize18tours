        ...
        <div class="row justify-content-center booking-two-column">
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="datetime-local" name="pickup_time" class="form-control" value="{{ old('pickup_time') }}" step="300" lang="en-GB" placeholder="dd/mm/yyyy hh:mm"/>
                    @error('pickup_time') <span class="text-danger">{{ $message }}</span> @enderror
                </div>
            </div>
            <div class="form-row" id="field-dropoff-time-row">
                <div class="form-group">
                    <label id="dropoff-time-label">Drop Off Date & Time</label>
                    <input type="datetime-local" name="dropoff_time" class="form-control" value="{{ old('dropoff_time') }}" step="300" lang="en-GB" placeholder="dd/mm/yyyy hh:mm"/>
